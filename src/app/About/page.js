  ...
  return (
    <>
      ...
      <div className="w-full h-full p-7">
        <div className="flex mobile:flex-col tablet:flex-row place-content-center">
          <div
            className={`${
              sliderOpen ? "ml-28" : "ml-0"
            } mobile:self-center tablet:self-start tablet:mr-4 laptop:mr-8 desktop:mr-8 my-4`}
          >
            ...
            <div className="flex flex-col bg-white place-content-center">
              <div className="self-center text-sm text-customFontColor font-bold mt-1 mb-1 hover:underline">
                <Link
          ...
          <div
            className={`${
              sliderOpen ? "mobile:ml-28 tablet:ml-0" : "ml-0"
            } mobile:self-center tablet:w-3/4 tablet:self-start laptop:self-start desktop:self-start my-4`}
          >
